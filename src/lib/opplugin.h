...
public:
  ...
  virtual ResultType execute(std::shared_ptr<FitsImage> image, QRect selection=QRect());

  virtual ResultType execute(const std::vector<QFileInfo>& list, QRect selection=QRect());
