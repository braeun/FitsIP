...
struct OpPluginData
{
  ...
  ImageCollection* imageCollection{nullptr};
  PixelList* pixellist{nullptr};
  StarList* starlist{nullptr};
};
...
public:
  ...
  virtual ResultType execute(std::shared_ptr<FitsObject> image, const OpPluginData& data=OpPluginData());

  virtual ResultType execute(const std::vector<QFileInfo>& list, const OpPluginData& data=OpPluginData());

  virtual ResultType execute(const std::vector<std::shared_ptr<FitsObject>>& list, const OpPluginData& data=OpPluginData());
...
protected:
  ...
  void log(FitsImage* image, const QString& msg);
