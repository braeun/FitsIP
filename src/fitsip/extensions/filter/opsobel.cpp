...
FitsImage OpSobel::applyFilter(const FitsImage&  img) const
{
  ...
  FitsImage img1(img.getName(),img.getWidth(),img.getHeight(),1);
...
ValueType* OpSobel::convolve(const FitsImage& img, const Kernel &kernel) const
{
